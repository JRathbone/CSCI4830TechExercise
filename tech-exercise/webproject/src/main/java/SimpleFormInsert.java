...
public class SimpleFormInsert extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String insertSql = " INSERT INTO inventory (id, name, quantity, imageURL) values (default, ?, ?, ?)";
      ...
      out.println(docType + //
            ...
            "  <li><b>Email</b>: " + quantity + "\n" + //
            "  <li><b>Phone</b>: " + imageURL + "\n" + //

            "</ul>\n");

      out.println("<a href=/webproject/Homepage>Homepage</a> <br>");
